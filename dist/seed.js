...
async function seed() {
    ...
    const listings = [
        ...
        { id: (0, nanoid_1.nanoid)(), ownerId: 'farmer3', ownerName: 'Мирлан Джумабеков', ownerRating: 4.3, ownerVerified: false, title: 'Тоок — жерги жер, бройлер', category: 'poultry', images: [imgs.chicken], description: 'Ачык аба аймагында өстүрүлгөн тоок. 45-60 күндүк. Дароо жеткирилет.', price: 250, currency: 'KGS', unit: 'кг', minOrder: 5, region: 'Ошская область', organic: false, exportReady: false, hasDelivery: true, inStock: true, vip: false, views: 78, createdAt: new Date(Date.now() - 3 * 86400000).toISOString() },
        ...
        { id: (0, nanoid_1.nanoid)(), ownerId: 'farmer2', ownerName: 'Тоо Булак', ownerRating: 4.6, ownerVerified: true, title: 'Сабиз — мезгилдик', category: 'vegetables', images: [imgs.carrot], description: 'Кызыл сабиз, жаңы жыйылган. Чоку бойдон сакталган.', price: 30, currency: 'KGS', unit: 'кг', minOrder: 100, region: 'Иссык-Кульская область', organic: true, exportReady: false, hasDelivery: true, inStock: true, vip: false, views: 67, createdAt: new Date(Date.now() - 8 * 86400000).toISOString() },
    ];
    const prices = [
        { id: (0, nanoid_1.nanoid)(), name: 'Картошка', category: 'Жашылча', unit: 'кг', avgPrice: 18, minPrice: 12, maxPrice: 25, weekChange: -3.5, monthChange: 12, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Пияз', category: 'Жашылча', unit: 'кг', avgPrice: 22, minPrice: 15, maxPrice: 30, weekChange: 5.2, monthChange: -8, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Сабиз', category: 'Жашылча', unit: 'кг', avgPrice: 35, minPrice: 25, maxPrice: 50, weekChange: 2.1, monthChange: 15, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Капуста', category: 'Жашылча', unit: 'кг', avgPrice: 28, minPrice: 20, maxPrice: 40, weekChange: -1.2, monthChange: 5, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Томат', category: 'Жашылча', unit: 'кг', avgPrice: 80, minPrice: 60, maxPrice: 120, weekChange: 8.5, monthChange: 22, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Уй эти', category: 'Мал', unit: 'кг', avgPrice: 450, minPrice: 380, maxPrice: 550, weekChange: 1.5, monthChange: 8, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Кой эти', category: 'Мал', unit: 'кг', avgPrice: 520, minPrice: 450, maxPrice: 620, weekChange: 3.2, monthChange: 12, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Жылкы эти', category: 'Мал', unit: 'кг', avgPrice: 480, minPrice: 420, maxPrice: 560, weekChange: 0, monthChange: 5, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Буудай', category: 'Дан', unit: 'кг', avgPrice: 14, minPrice: 11, maxPrice: 18, weekChange: -0.5, monthChange: 3, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Арпа', category: 'Дан', unit: 'кг', avgPrice: 11, minPrice: 9, maxPrice: 14, weekChange: 1.0, monthChange: 7, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Жүгөрү', category: 'Дан', unit: 'кг', avgPrice: 16, minPrice: 13, maxPrice: 20, weekChange: -2.0, monthChange: -5, updatedAt: new Date().toISOString() },
        { id: (0, nanoid_1.nanoid)(), name: 'Бал', category: 'Башкалар', unit: 'кг', avgPrice: 700, minPrice: 500, maxPrice: 900, weekChange: 0, monthChange: 10, updatedAt: new Date().toISOString() },
    ];
    db.users.push(...users);
    db.listings.push(...listings);
    db.prices.push(...prices);
    db.announcements.push({ id: (0, nanoid_1.nanoid)(), authorId: 'buyer1', authorName: 'Марат Беков', authorRole: 'buyer', title: '100 тонна картошка керек — опт', category: 'vegetables', qty: 100000, unit: 'кг', region: 'Бишкек', description: 'Чуй же Ош чарбасынан картошка сатып алам. Туруктуу жеткирүү менен. Баасын сүйлөшөбүз.', deadline: '2025-11-01', status: 'open', offerCount: 7, createdAt: new Date(Date.now() - 3 * 86400000).toISOString() }, { id: (0, nanoid_1.nanoid)(), authorId: 'exporter1', authorName: 'KG Export LLC', authorRole: 'exporter', title: 'Экспорт үчүн алма керек — 50 тонна', category: 'fruits', qty: 50000, unit: 'кг', region: '', description: 'Сертификаттуу органикалык алма. Казахстанга экспорт. Талапка ылайык жеткирүү.', status: 'open', offerCount: 3, createdAt: new Date(Date.now() - 7 * 86400000).toISOString() });
    db.transports.push({ id: (0, nanoid_1.nanoid)(), ownerId: 'transport1', ownerName: 'КамАЗ ЖЧК', ownerPhone: '+996700666666', type: 'kamaz', capacity: '20 тонна', route: 'Ош — Бишкек', availableDates: 'Дүйшөмбү, Сейшемби, Бейшемби', region: 'Ошская область', price: 35000, createdAt: new Date(Date.now() - 5 * 86400000).toISOString() }, { id: (0, nanoid_1.nanoid)(), ownerId: 'farmer1', ownerName: 'Айбек Турсунов', ownerPhone: '+996700111111', type: 'gazelle', capacity: '2 тонна', route: 'Чуй — Бишкек', availableDates: 'Ар күн', region: 'Чуйская область', price: 5000, createdAt: new Date(Date.now() - 2 * 86400000).toISOString() });
    (0, db_1.writeDb)(db);
